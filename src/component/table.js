...
export default function EnhancedTable({ isLoading, dataSearch }) {
  ...
  //      setRowsData(item[0]?.data);
  //      setRowsTimestamp(item[0]?.timestamp);
  //     });
  //   }
  //   console.log('dataSearch=====', dataSearch);
  // }, [dataSearch]);

  // console.log('dataSearch=====', rowsData, rowsTimestamp);
        ...
        <Box className="MarginCard marginCardCalendar">
          {dataSearch.length > 0 && (
            <Paper sx={{ width: "100%", mb: 2 }}>
              ...
              <TableContainer className={classes.flexRow}>
